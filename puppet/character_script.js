...
function buildStickBear(
  ...
  transY(headGeo, 4);
  var manMat = new THREE.MeshLambertMaterial({
    map: headTex,
    transparent: true,
    alphaTest: 0.5,
  ...
  transZ(bG, 4);
  manMat = new THREE.MeshLambertMaterial({
    map: bodyTex,
    transparent: true,
    alphaTest: 0.5,
    side: THREE.DoubleSide
...
function loopRecordedData() {
  ...
  if (Date.now() > sentTime + 20) {
    gotBodies(recorded_skeleton[currentFrame]);
    sentTime = Date.now();
...
function update() {
  ...
  //relate to joints[5]
  hL2MoveX =
    Math.sqrt(Math.pow(joints[0].position.x - joints[5].position.x, 2)) - 5;
  hL2MoveY = Math.sqrt(
    Math.pow(joints[0].position.y - joints[5].position.y, 2)
  );
  ...
  //relate to joints[5]
  hL1MoveX =
    Math.sqrt(Math.pow(joints[4].position.x - joints[5].position.x, 2)) - 5;
  hL1MoveY = Math.sqrt(
    Math.pow(joints[4].position.y - joints[5].position.y, 2)
  );
  ...
  //relate to joints[3]
  hR2MoveX =
    Math.sqrt(Math.pow(joints[0].position.x - joints[3].position.x, 2)) - 5;
  hR2MoveY = Math.sqrt(
    Math.pow(joints[0].position.y - joints[3].position.y, 2)
  );
  ...
  //relate to joints[2]
  hR1MoveX =
    Math.sqrt(Math.pow(joints[2].position.x - joints[3].position.x, 2)) - 5;
  hR1MoveY = Math.sqrt(
    Math.pow(joints[2].position.y - joints[3].position.y, 2)
  );
  ...
  //relate to joints[9]
  lL2MoveX =
    Math.sqrt(Math.pow(joints[1].position.x - joints[9].position.x, 2)) - 3;
  lL2MoveY =
    Math.sqrt(Math.pow(joints[1].position.y - joints[9].position.y, 2)) - 5;
  ...
  //relate to joints[8]
  lL1MoveX = Math.sqrt(
    Math.pow(joints[8].position.x - joints[9].position.x, 2)
  );
  lL1MoveY =
    Math.sqrt(Math.pow(joints[8].position.y - joints[9].position.y, 2)) - 6;
  ...
  //relate to joints[7]
  lR2MoveX =
    Math.sqrt(Math.pow(joints[1].position.x - joints[7].position.x, 2)) - 3;
  lR2MoveY =
    Math.sqrt(Math.pow(joints[1].position.y - joints[7].position.y, 2)) - 5;
  ...
  //relate to joints[6]
  lR1MoveX = Math.sqrt(
    Math.pow(joints[6].position.x - joints[7].position.x, 2)
  );
  lR1MoveY =
    Math.sqrt(Math.pow(joints[6].position.y - joints[7].position.y, 2)) - 6;
